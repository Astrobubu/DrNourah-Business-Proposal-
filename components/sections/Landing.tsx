...
export function Landing({ onLanguageSelect, data, selectorData }: LandingProps) {
    return (
        <section className="min-h-screen flex flex-col items-center justify-center relative z-10 px-6 text-center">
            ...
            >
                <h1 className="text-3xl md:text-7xl font-bold mb-4 text-gray-900 leading-tight font-heading">
                    {data.welcome}
                </h1>
                <h1
                    className="text-4xl md:text-8xl font-bold mb-12 text-gray-900 leading-tight font-heading"
